...
const OurStory = () => {
  ...
  return (
    <section id="story" className="w-full min-h-screen relative flex items-center justify-center overflow-hidden py-24 md:py-36" style={{ background: "var(--black-2)" }}>
      {/* Background Image/Overlay — Matching the moody hands visual */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Central glow effect from image */}
      ...
      <div className="max-w-[1440px] w-full mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        <div className="max-w-4xl">
          ...
          >
            <h3 className="text-white text-2xl md:text-4xl lg:text-5xl font-display leading-[1.3] mb-10 font-medium">
            ...
            <p className="text-white/70 text-lg md:text-2xl lg:text-3xl font-display leading-[1.4] mb-16 max-w-3xl">
